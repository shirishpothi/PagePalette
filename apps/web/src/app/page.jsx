      ...
      <section className="relative py-24 px-6 z-10">
        ...
        >
          <div className="bg-gradient-to-br from-[#0f1115] to-[#151515] rounded-3xl border border-[#1f1f1f] py-16 px-8 relative overflow-hidden group">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-proxima-sera relative z-10">
              Ready to Get Your<br />
              <span className="bg-gradient-to-r from-[#4ADE80] to-[#764134] bg-clip-text text-transparent">
                PagePalette?
              </span>
            </h2>
